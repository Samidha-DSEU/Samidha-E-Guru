...
from sqlalchemy import String, Text, Integer, BigInteger, Float, Boolean, ForeignKey, DateTime, UniqueConstraint
...
class Resource(Base):
    ...
    resource_source: Mapped["ResourceSource"] = relationship(back_populates="resources")
