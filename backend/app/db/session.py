...
def ensure_schema_migrations(engine):
    ...
    statements = [
        ...
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS class_code VARCHAR(20);",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS total_subjects_found INTEGER DEFAULT 0;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS total_chapters_found INTEGER DEFAULT 0;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS scraped_success_count INTEGER DEFAULT 0;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS scraped_failed_count INTEGER DEFAULT 0;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS duration_seconds FLOAT DEFAULT 0.0;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS telemetry_details JSONB;",
        "ALTER TABLE scraper_jobs ADD COLUMN IF NOT EXISTS scraped_sheet JSONB;",
